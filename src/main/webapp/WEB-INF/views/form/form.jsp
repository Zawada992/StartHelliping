...
<spring:message code="app.street" var="street"/>
<spring:message code="app.city" var="city"/>
<spring:message code="app.zipCode" var="zipCode"/>
<spring:message code="app.pickUpDate" var="date"/>
<spring:message code="app.pickUpTime" var="time"/>
<spring:message code="app.pickUpComment" var="comment"/>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        <h4>Adres odbioru</h4>
                        <div class="form-group form-group--inline">
                            <label> ${street} <form:input path="street"/> </label>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> ${date} <form:input type="date" path="pickUpDate"/> </label>
                            <form:errors path="pickUpDate" cssClass="error"/>
                        </div>
                        <div class="form-group form-group--inline">
                            <label> ${time} <form:input type="time" path="pickUpTime" /> </label>
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text">
                                    <span class="summary-quantity"></span> worki -
