    ...
    <table class="custom-table">
        ...
        <c:forEach items="${donations}" var="donation">
            <tr class="custom-tr">
                ...
                <td class="custom-td">
                    <c:if test="${!donation.taken}">
                        <a href="/app/${user.id}/donations/mark-as-taken/${donation.id}" class="btn btn--without-border">Oznacz jako odebrane</a>
                    </c:if>
                    <a href="/app/${user.id}/donation/${donation.id}" class="btn btn--without-border">Szczegóły</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
